...
class ScenarioEngineTests(unittest.TestCase):
    ...
    def test_catalog_has_a_benign_twin_for_every_scenario(self):
        ...
        self.assertEqual(len(scenario_ids), 19)
    ...
    def test_all_scenarios_emit_ground_truth_and_pass_controls(self):
        ...
        self.assertEqual(result.event_count, 120)
        self.assertEqual(result.trace_count, 38)
        ...
        self.assertEqual(report["summary"]["passed"], 38)
        self.assertEqual(report["summary"]["failed"], 0)
        self.assertTrue(report["summary"]["all_passed"])
        self.assertEqual(report["metrics"]["true_positive"], 19)
        self.assertEqual(report["metrics"]["true_negative"], 19)
