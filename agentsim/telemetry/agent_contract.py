...
def agent_trace_from_record(
    ...
    return AgentTraceEvent(
        ...
        delegated_from_agent_id=_string(record, "delegated_from_agent_id"),
        delegated_to_agent_id=_string(record, "delegated_to_agent_id"),
        identity_binding_valid=_boolean(record, "identity_binding_valid"),
        data_lineage_id=_string(record, "data_lineage_id"),
        memory_id=_string(record, "memory_id"),
        memory_scope=_string(record, "memory_scope"),
        memory_provenance_valid=_boolean(record, "memory_provenance_valid"),
        memory_retention_valid=_boolean(record, "memory_retention_valid"),
        goal_id=_string(record, "goal_id"),
        goal_fingerprint=_string(record, "goal_fingerprint"),
        goal_integrity_valid=_boolean(record, "goal_integrity_valid"),
        goal_change_approved=_boolean(record, "goal_change_approved"),
